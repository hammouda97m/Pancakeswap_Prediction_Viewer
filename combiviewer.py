...
with open("prediction_abi.json", "r") as f:
    ABI = json.load(f)
web3 = Web3(Web3.HTTPProvider("https://tiniest-still-wind.bsc.quiknode.pro/3f8ae99c7e83e1900727637af9e19e3f195c5f7a/"))
...
def check_streak_and_notify():
    """Check for streaks of 4+ and send Telegram notification"""
...
def check_price_movement_and_notify():
    """Check for price movements >$1.75 and send Telegram notification"""
